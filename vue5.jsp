...
<body>
<!-- 
	v-model을 사용시 checked 속성이 적용되지 않음. vue에서 data 가상 변수값에 value값과 동일한 값을 적용하면 자동으로 checked가 설정되어짐 (checkbox)
 -->
	<section id="box">
...
<!-- 상품검색 응용편 -->
	<section id="box2">
		<form id="sh" method="get" action="./vue5.jsp" v-on:submit="gopage">
			상품검색 : <input type="text" name="search" v-model="search">
			<button>검색</button>
		</form>
	</section>
</body>
<script src="./vue5.js?v=4"></script>
</html>